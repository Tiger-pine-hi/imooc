    ...
    <div class="tabbable col-md-4  product-container" id="login_table"  >
        ...
        <div class="tab-content ">
            ...
            <div class="tab-pane active" id="teacher" >
                <form class="form-group" id="teachForm"  method="post">
                    <div class="form-group top_taable">
                        ...
                        <input class="form-control" type="text" id="tname"  name="tname" placeholder="请输入教师昵称">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                        <label for="tphone"></label>
                        <input class="form-control" type="text"  id="tphone" name="tphone" placeholder="请输入手机号码">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                        <label for="tpassword"></label>
                        <input class="form-control" type="password"  id="tpassword" name="tpassword" placeholder="至少6位字母或数字的密码">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-center ">
                        ...
                        <button class="btn btn-primary btn-login" id="t_registeres" type="button" onclick="t_reg_submit()">注册</button>
                    </div>
                </form>
            </div>
            ...
            <div class="tab-pane" id="student">
                <form class="form-group" id="studentForm" method="post">
                    <div class="form-group top_taable">
                        <label for="sname"></label>
                        <input class="form-control" type="text" id="sname" name="sname" placeholder="请输入学生昵称">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                        <label for="sphone"></label>
                        <input class="form-control" type="text"  id="sphone" name="sphone" placeholder="请输入手机号码">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                        <label for="spassword"></label>
                        <input class="form-control" type="password"  id="spassword" name="spassword" placeholder="至少6位字母或数字的密码">
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group">
                        <div class="row text-center">
                            ...
                            <div class="col-md-offset-4 ">
                                    <span onclick="changeImage_student()">
                    ...
                    <div class="text-center ">
                        ...
                        <button class="btn btn-primary btn-login" id="s_registered" type="button" onclick="s_reg_submit()">注册</button>
                    </div>
                </form>
            </div>
        </div>
